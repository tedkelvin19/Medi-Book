...
export default function LoginPage() {
  ...
  // Secret admin unlock — Ctrl+Shift+A
  useEffect(() => {
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className={`w-full py-3 text-white font-bold rounded-lg text-sm transition-colors disabled:opacity-60
              ${role === 'admin'
